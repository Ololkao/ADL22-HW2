...
def main():
    ...
    if training_args.do_predict:
        ...
        for i, pred in enumerate(preds):
            squad = {}
            squad['id'] = test_dataset[i]['video-id']
            squad['question'] = test_dataset[i]['sent1']
            squad['context'] = test_dataset[i][f'ending{pred}']
            # squad['answers'] = {"text": "", "answer_start": 0}
            output.append(squad)
        with open("format_test.json", "w", encoding='utf-8') as file:
